![docker image](https://github.com/GinzburgLev/nomad-distro/actions/workflows/docker-publish.yml/badge.svg)


# GinzburgLev's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of GinzburgLev.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/GinzburgLev/nomad-distro.git
    cd nomad-distro
    ```
    ...
    ```sh
    curl-L -o nomad-distro.zip "https://github.com/GinzburgLev/nomad-distro/archive/main.zip"
    unzip nomad-distro.zip
    cd nomad-distro
    ```
...
your `docker-compose.yaml` with `ghcr.io/ginzburglev/nomad-distro:main` for the services
...
```sh
docker pull ghcr.io/ginzburglev/nomad-distro/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/GinzburgLev/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/GinzburgLev/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/GinzburgLev/nomad-distro/manifests/main": unauthorized`
